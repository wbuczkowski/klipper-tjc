...
class AxesDisplayMask(Mask):
    ...
    def __init__(self, com_interface: SerialCommunication,
                 web_sock : WebsocketInterface,
                 display : Display) -> None:
        super().__init__(1, com_interface)
        self.web_socket = web_sock
        self.display = display

        self.xpos = MoonrakerDataVariable(self._com_interface,
                                          DataAddress.LIVE_X_POS,
                                          2,
        ...
        self.ypos = MoonrakerDataVariable(self._com_interface,
                                          DataAddress.LIVE_Y_POS,
                                          2,
                                          DataAddress.UNDEFINED,
                                          self.web_socket)
        ...
        self.zpos = MoonrakerDataVariable(self._com_interface,
                                          DataAddress.LIVE_Z_POS,
                                          2,
                                          DataAddress.UNDEFINED,
                                          self.web_socket)
        ...
        com_interface.register_spontaneous_callback(DataAddress.SPONT_MOVE_DISTANCE,
                                                    self.move_distance_changed)
        com_interface.register_spontaneous_callback(DataAddress.SPONT_MOVE_BUTTON,
                                                    self.key_pressed)
